...
def create_register_table(cursor: sqlite3.Cursor):
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS registers (
            ...
            hdl_path TEXT,
            register_read_action TEXT,         -- Added field for readAction
            created_date TEXT,
            ...
            if cursor.fetchone()[0] == 0:
                cursor.execute('''
                    INSERT INTO registers (
                        ...
                        register_fields, hdl_path, register_read_action, created_date
                    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                ''', (
                    ...
                    register['hdl_path'],
                    register['register_read_action'],  # Include readAction
